...
def load_data():
    train_dataset = h5py.File('baggage_data/train_data.h5', "r")
    train_set_x_orig = np.array(train_dataset["train_set_x"][:])  # your train set features
    train_set_y_orig = np.array(train_dataset["train_set_y"][:])  # your train set labels

    test_dataset = h5py.File('baggage_data/test_data.h5', "r")
...
def predict(X, y, parameters, append_msg=""):
    """
    ...
    print(append_msg + "Accuracy: " + str(np.sum((p == y) / m)))
...
layers_dims = (12288, 100, 70, 50, 40, 15, 5, 1)

parameters = L_layer_model(train_x, train_y, layers_dims, learning_rate=0.001, num_iterations=20000, print_cost=True)
